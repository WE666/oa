            ...
            <div class="panel heading-border">
                <form:form action="/employee/update" modelAttribute="employee"  id="admin-form" name="addForm">
                    ...
                    <div class="panel-body bg-light">
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="num" class="field prepend-icon">
                                    <form:input path="num" cssClass="gui-input" placeholder="工号..." readonly="true" />
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="num" class="field select">
                                    <form:select path="departmentNum" items="${dlist}" itemLabel="name" itemValue="num" cssClass="gui-input" placeholder="所属部门..."/>
